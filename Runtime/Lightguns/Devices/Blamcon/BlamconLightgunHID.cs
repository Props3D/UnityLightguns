...
namespace Blamcon.Lightguns
{
    ...
    public class BlamconLightgunHID : Lightgun, IForceFeedback
    {
        ...
        /// into one report, so they take effect together. Firmware 2.1.0 and later queues reports and applies
        /// them in order, so separate calls are delivered too, but a recoil sent while the previous pulses are
        /// still running is ignored (constraint 6).
        /// </summary>
        /// <param name="player">0-based player index: 0 is player 1.</param>
